%% This is the 1D decompression-diffusion function that is called upon by the main code (emb_diffusion.m)
function [nodes, H2O_array, CO2_array] = diffusion_function(P_i, P_f, lengthi, radius, H2O_i, rho, TC, dPdt)
